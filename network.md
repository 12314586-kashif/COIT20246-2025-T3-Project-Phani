...
![Truelec Complete Network Design](images/Truelec_Network_Design_Complete.jpeg)
...
### Branch Brisbane (63.101.0.0/24 - Sayed ID)

| System           | IP Address/Range | Details |
|------------------|------------------|---------|
| Staff Network    | 63.101.0.0/24    | 20 employees |
| Local Server     | 63.101.0.50      | Dell PowerEdge R360 - Booking App |
| WAN Link to HQ   | 63.110.0.0/30    | MPLS Primary Circuit |
| WAN IP Brisbane | 63.110.0.2/30    | ISR 4331 Router Interface |
| WAN IP HQ       | 63.110.0.1/30    | ASR 1002 Router Interface |
